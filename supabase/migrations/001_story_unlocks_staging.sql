-- couple-quiz-staging: mesmo schema da producao, PIN admin diferente (staging123)
-- Aplicar apenas no projeto couple-quiz-staging (org Carlos)
...
insert into public.app_settings (key, value) values
  ('admin_pin_hash', extensions.crypt('staging123', extensions.gen_salt('bf')));
